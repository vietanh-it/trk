                    ...
                    <form action="javascript:void(0)" method="post" id="form-checkout">
                                            ...
                                            <div class="radio-group-addon delivery-option">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-xs-8">
                                                        <b>Thanh toán khi nhận hàng</b><br>Quý khách
                                                                                           sẽ thanh
                                                                                           toán
                                        ...
                                        <label>
                                            ...
                                            <div class="radio-group-addon delivery-option">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-xs-8">
                                                        <b>Thanh toán bằng thẻ ATM</b><br>Thẻ ATM của
                                                                                          bạn cần
                                                                                          đăng
                        ...
                        <?php }
                            ...
                            <div class="text-center">
                                <a href="<?php echo WP_SITEURL . '/gio-hang?step=2'; ?>" class="btn btn-primary btn-cart-continue" style="margin-top: 50px;">
                                    Tiếp theo
                                </a>
                            </div>
                        <?php } ?>
